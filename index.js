...
bot.on("messageCreate", msg => {
    ...
    //else if (msg.author.id !== '87600987040120832') return; //Used only if I want to disable the bot for everyone but me while testing/debugging
        ...
        if (msg.channel.guild) {
            ...
            if (msg.content.startsWith(options.prefix + 'prefix') || msg.content.startsWith(options.prefix + 'checkprefix')) msg.content = msg.content.replace(options.prefix, msgPrefix)
        }
