...
<html lang="en">
<head>
    <title>Code coverage report for dist/wiki.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">dist/wiki.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">dist/</a> &#187; wiki.js</div>
</div>
<div class="body">
...
&nbsp;
			return new _Promise(function (resolve, reject) {
				_this2.api(params).then(function (res) {
					...
					if (res['continue']) {
						var continueType = _Object$keys(res['continue']).filter(function (key) {
							return key !== 'continue';
						})[0];
		...
		value: function aggregatePagination(pagination) {
			var _this3 = this;
&nbsp;
			var previousResults = arguments[1] === undefined ? [] : arguments[1];
&nbsp;
			return new _Promise(function (resolve, reject) {
				pagination.then(function (res) {
					var results = previousResults.concat(res.results);
					if (res.next) {
						resolve(_this3.aggregatePagination(res.next(), results));
					} else {
						resolve(results);
					}
				})['catch'](reject);
...
&nbsp;
   ...
   */
		value: function random() {
			var _this4 = this;
&nbsp;
			var limit = arguments[0] === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: arguments[0];
&nbsp;
			return new _Promise(function (resolve, reject) {
				_this4.api({
					list: 'random',
...
<span class="cstat-no" title="statement not covered" >						reject(new Error('No article found'));</span>
					} else {
...
&nbsp;
   ...
   */
		value: function geoSearch(lat, lon) {
			var _this6 = this;
&nbsp;
			var radius = arguments[2] === undefined ? 1000 : <span class="branch-1 cbranch-no" title="branch not covered" >arguments[2];</span>
			// 1km
			return new _Promise(function (resolve, reject) {
				_this6.api({
					list: 'geosearch',
...
&nbsp;
			return new _Promise(function (resolve, reject) {
				_this10.wiki.api({
					...
					var urls = null;
					if (res.query) {
						urls = _import2['default'].chain(res.query.pages).pluck('imageinfo').flatten().pluck('url').value();
					} else {
						urls = [];
					}
					resolve(urls);
...
&nbsp;
   ...
   */
		value: function links() {
			var _this12 = this;
&nbsp;
			var aggregated = arguments[0] === undefined ? true : <span class="branch-1 cbranch-no" title="branch not covered" >arguments[0];</span>
			var limit = arguments[1] === undefined ? 100 : <span class="branch-1 cbranch-no" title="branch not covered" >arguments[1];</span>
&nbsp;
			...
			<span class="missing-if-branch" title="else path not taken" >E</span>if (aggregated) {
