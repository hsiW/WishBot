...
module.exports = {
    ...
    process: (bot, msg, suffix) => {
        search({
            ...
            if (result.length === 0) bot.createMessage(msg.channel.id, "Your search returned no results. Please forgive me **" + msg.author.username + "**-senpai!").then(message => utils.messageDelete(bot, message, null));
            else {
